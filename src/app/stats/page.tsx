...
export default function StatsPage() {
  ...
  const enhancedStats = useMemo(() => {
    ...
    // Highest rating attempted (solved + failed)
  ...
  // Rating distribution buckets for bar chart
  ...
  // Batched animated count targets (single rAF loop for all 5 values)
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] stats-page-reveal">
